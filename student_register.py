...
eye_open_icon_image = Image.open("C:/Users/Jeevan/OneDrive/Desktop/python/RLMS/Remote Lab Monitoring System/Show.png")  # Replace with the path to your open eye icon image
eye_closed_icon_image = Image.open("C:/Users/Jeevan/OneDrive/Desktop/python/RLMS/Remote Lab Monitoring System/Hidden.png")  # Replace with the path to your closed eye icon image
